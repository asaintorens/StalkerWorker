...
namespace Examplinvi
{
    ...
    class Program
    {
        ...
        static void Main()
        {
            TwitterCredentials.SetCredentials("1693649419-VMA9sF1hhTRzP0H6eBSsxBU4KOidn1PrVm8Uu2q", "b8kmpeAuuvotFB0O54YDCwT6nrnx6HCRQoyH3GHZQWlaZ", "xWMytIGSmXPuPe9OxwlQz1Wac", "n1l88uNwskBSu8hkuAumxieDRYKPKf7j4C13nbvAt0Z8ubu5iG");


            var sp = User.GetFollowers("ladygaga", 7000);
        ...
        {
            var applicationCredentials = CredentialsCreator.GenerateApplicationCredentials(consumerKey, consumerSecret);
            var url = CredentialsCreator.GetAuthorizationURLForCallback(applicationCredentials, "https://tweetinvi.codeplex.com?salut=3");
            Console.WriteLine("Go on : {0}", url);
